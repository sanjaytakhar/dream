...
export const mockTests = [
  {
    id: 'c6-maths-ch10-t1',
    title: 'Class 6 Maths - Test 1: Integers, Lift Model & Number Line',
    titleHi: 'कक्षा 6 गणित - टेस्ट 1: पूर्णांक परिचय, लिफ्ट मॉडल एवं संख्या रेखा',
    schoolClass: 'Class 6',
    subject: 'Mathematics',
    subjectHi: 'गणित (अध्याय 10)',
    difficulty: 'Easy',
    ...
    attempts: 230,
    rating: 4.9,
    tags: ['Class 6', 'Mathematics', 'Integers', 'NCERT', 'Chapter 10'],
    featured: true,
  },
  {
    id: 'c6-maths-ch10-t2',
    title: 'Class 6 Maths - Test 2: Token Model & Integer Operations (Add & Subtract)',
    titleHi: 'कक्षा 6 गणित - टेस्ट 2: टोकन मॉडल एवं पूर्णांक संक्रियाएँ (जोड़ व घटाव)',
    schoolClass: 'Class 6',
    subject: 'Mathematics',
    subjectHi: 'गणित (अध्याय 10)',
    difficulty: 'Medium',
    ...
    attempts: 215,
    rating: 4.9,
    tags: ['Class 6', 'Mathematics', 'Token Model', 'NCERT', 'Chapter 10'],
    featured: true,
  },
  {
    id: 'c6-maths-ch10-t3',
    title: 'Class 6 Maths - Test 3: Real-Life Integers, Grids & Brahmagupta\'s Rules',
    titleHi: 'कक्षा 6 गणित - टेस्ट 3: दैनिक जीवन में पूर्णांक, ग्रिड पहेली एवं ब्रह्मगुप्त के नियम',
    schoolClass: 'Class 6',
    subject: 'Mathematics',
    subjectHi: 'गणित (अध्याय 10)',
    difficulty: 'Medium',
    ...
    attempts: 195,
    rating: 5.0,
    tags: ['Class 6', 'Mathematics', 'Brahmagupta Rules', 'NCERT', 'Chapter 10'],
    featured: true,
  },
  {
  ...
  {
    id: 'c8-sci-t6-crops-set2',
    title: 'Class 8 Science - Test 6: Crop Production & Management (Advanced Set 2)',
    titleHi: 'कक्षा 8 विज्ञान - टेस्ट 6: फसल उत्पादन एवं प्रबंध (अभ्यास सेट 2)',
    schoolClass: 'Class 8',
    subject: 'Science',
    subjectHi: 'विज्ञान',
    difficulty: 'Medium',
    ...
    attempts: 215,
    rating: 4.9,
    tags: ['Class 8', 'Science', 'NCERT', 'Chapter 1', 'Set 2'],
    featured: true,
  },
  {
    id: 'c8-sci-t7-coal-set2',
    title: 'Class 8 Science - Test 7: Coal and Petroleum (Deep Dive Set 2)',
    titleHi: 'कक्षा 8 विज्ञान - टेस्ट 7: कोयला और पेट्रोलियम (अभ्यास सेट 2)',
    schoolClass: 'Class 8',
    subject: 'Science',
    subjectHi: 'विज्ञान',
    difficulty: 'Medium',
    ...
    attempts: 184,
    rating: 4.8,
    tags: ['Class 8', 'Science', 'NCERT', 'Chapter 5', 'Set 2'],
    featured: true,
  },
  {
    id: 'c8-sci-t8-conservation-set2',
    title: 'Class 8 Science - Test 8: Conservation of Plants & Animals (Mastery Set 2)',
    titleHi: 'कक्षा 8 विज्ञान - टेस्ट 8: पौधे एवं जंतुओं का संरक्षण (अभ्यास सेट 2)',
    schoolClass: 'Class 8',
    subject: 'Science',
    subjectHi: 'विज्ञान',
    difficulty: 'Medium',
    ...
    attempts: 196,
    rating: 4.9,
    tags: ['Class 8', 'Science', 'NCERT', 'Chapter 7', 'Set 2'],
    featured: true,
  },
  {
    id: 'c8-sci-t9-mastery',
    title: 'Class 8 Science - Test 9: Mid-Term Comprehensive Revision Mock',
    titleHi: 'कक्षा 8 विज्ञान - टेस्ट 9: अर्द्धवार्षिक सम्पूर्ण पाठ्यक्रम रिवीजन मॉक',
    schoolClass: 'Class 8',
    subject: 'Science',
    subjectHi: 'विज्ञान',
    difficulty: 'Hard',
    ...
    attempts: 260,
    rating: 5.0,
    tags: ['Class 8', 'Science', 'Ch 1, 5, 7', 'Mastery Mock'],
    featured: true,
  },
  {
