...
export const StarIcon = ({ className = "w-4 h-4 fill-amber-400 text-amber-400" }) => (
...
export const BookmarkIcon = ({ className = "w-4 h-4", filled = false }) => (
...
export const FlameIcon = ({ className = "w-4 h-4 text-orange-500" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2c.5 1.5 2 3.5 2 6 0 1-.5 2-1 2.5 2-.5 3-2 3-4 2 2.5 3 5.5 3 8.5 0 4.5-3.5 7-8 7s-8-2.5-8-7c0-4 3-7 5-9 0 2 1 3 2 3 .5-.5 1-2.5 1-7z"/>
  </svg>
);

export const TrophyIcon = ({ className = "w-4 h-4 text-amber-500" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const BarChartIcon = ({ className = "w-4 h-4" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const LayoutDashboardIcon = ({ className = "w-4 h-4" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
